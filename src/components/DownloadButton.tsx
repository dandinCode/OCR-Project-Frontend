...
const DownloadButton: React.FC<DownloadButtonProps>  = ({documentId}) => {
  ...
  return (
    <button onClick={handleDownload} className="p-1 rounded" title="Baixar documento">
        <svg className="w-7 h-7 me-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
